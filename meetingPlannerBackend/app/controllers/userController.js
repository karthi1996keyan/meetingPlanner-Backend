...
var appUrl="http://localhost:4200/user" //url of front end application
/**
 * signup function
                    ...
                    newUser.save((err,successData)=>
                    {
                        ...
                        else
                        {
                            ...
                            let sendMailDetails=
                            {
                                ...
                                <br>
                                <a href="${appUrl}/verifyEmail/${newObj.userId}">
                                Click Here
                                </a>`
                            }
                    ...
                    (err,result)=>
                    {
                        ...
                        else
                        {
                            ...
                            let sendMailDetails=
                            {
                                ...
                                <br>
                                <a href="${appUrl}/verifyEmail/${retrievedUserDetailsWithToken.token}">
                                Click Here
                                </a>`
